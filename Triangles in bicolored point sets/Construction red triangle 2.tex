...
\usetikzlibrary{arrows.meta,angles,arrows,quotes,backgrounds, shapes}
...
\thispagestyle{empty}
    ...
    %blue points
        \foreach \i in {1,2} {
            \node[fill, \clrone, star] (b\i) at (360*\i/7:5) {};
        }
        \foreach \i in {3,4} {
            \node[fill, \clrone] (b\i) at (360*\i/7:5) {};
        }
        \foreach \i in {5,6,7} {
            \node[fill, \clrone, diamond] (b\i) at (360*\i/7:5) {};
        }
...
\begin{scope}[rotate = -12.68]
        \draw[thick, \clrtwo] (3,2) -- (-5,4) -- (-2.5,-7.5) -- cycle;
        \fill[\clrtwo, opacity = .1] (3,2) -- (-5,4) -- (-2.5,-7.5) -- cycle;
        \draw[thick, \clrtwo] (-6,4.25) -- (7,1);
        \node at (7,1.5) {\Huge$\ell_1$};
        \draw[thick, \clrtwo] (3,2) -- (-3,-8.3333);
        \node at (-2.5,-8.3333) {\Huge$\ell_2$};
        \node at (-5,2) {\Huge$\ell_3$};
\end{scope}
    \end{tikzpicture}
\end{document}